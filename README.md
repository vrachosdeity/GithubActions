[![Run App Mengelkamp, Peter](https://github.com/vrachosdeity/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/vrachosdeity/GithubActions/actions/workflows/ci.yml)
